...
const AboutUs = () => {
    ...
    <div className="carousel w-full lg:w-auto rounded-2xl overflow-hidden">
        <div id="item1" className="carousel-item w-full lg:w-auto">
            <img src="https://i.ibb.co/gPRXDbZ/scriptures-candles-wooden-table.jpg" className="w-full" />
        </div>
        <div id="item2" className="carousel-item w-full lg:w-auto">
            <img src="https://i.ibb.co/mhFFHvY/open-book-with-fairytale-scene.jpg" className="w-full" />
        </div>
        <div id="item3" className="carousel-item w-full lg:w-auto">
            <img src="https://i.ibb.co/gPRXDbZ/scriptures-candles-wooden-table.jpg" className="w-full" />
        </div>
        <div id="item4" className="carousel-item w-full lg:w-auto">
            <img src="https://i.ibb.co/mhFFHvY/open-book-with-fairytale-scene.jpg" className="w-full" />
        </div>
    </div>
